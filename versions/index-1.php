...
<div class="container-fluid">
  ...
  <div class="btn-group" role="group" aria-label="buttons">
      <button id="home_click" type="button" class="btn btn-default">Home</button>
      <button id="settings_click" type="button" class="btn btn-default">Settings</button>
      <button id="about_click" type="button" class="btn btn-default">About</button>
  </div>
  ...
  <div class="row">
    ...
    <div id="bpm_graph" class="row">
      <div class="col-md-4">
        <h3>Average heart rate by day</h3>
      </div>
      <div id="bpm_vitals" class="row"></div>
    </div>
    

    <div id="pressure_graph" class="row">
      <div class="col-md-4">
        <h3>Average blood pressure by day</h3>
      </div>
      <div id="pressure_vitals" class="row"></div>
    </div>

    <div id="temp_graph" class="row">
      <div class="col-md-4">
        <h3>Average body temperature by day</h3>
      </div>
      <div id="temp_vitals" class="row"></div>
    </div>
  </div>
