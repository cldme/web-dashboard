    ...
    <div class="col-md-3">
      ...
      <div id="home_us" class="well">
        ...
        <dl class="dl-horizontal">
          ...
          <dt>No. steps</dt><dd id="gps">267 <span class="glyphicons"><img src="steps.png"></span> </dd>
        </dl>
      </div>
    </div>
  ...
  <div id="content_settings">
    <div class="row">
      ...
      <div class="well">
        ...
        <p><button class="btn btn-default" onclick="alert('Sorry! This setting is not yet implemented. Try again later.')">Browse</button></p>
      </div>
      </div>
...
<script type="text/javascript">
  ...
  $("document").ready(function() {
    ...
    $("#collapse_all").click(function() {
      ...
      //probably the biggest hack in the history of comp science
      //had to get the value of "hide" but there are multiple <small> tags
      //this means jQuery grabs all of then and concatenates
      var property = $("small[id*=_hide]").text();
      property.split("hide");
      property = property[0]+property[1]+property[2]+property[3];

      if(property == "hide") {
         $("small[id*=_hide]").text("show");
      }
      else {
        $("small[id*=_hide]").text("hide");
      }
